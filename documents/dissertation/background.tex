...
\section{Reproducibility and Auditability of software}
...
American Physical Society \citep{APS:aa} describes science as "the systematic enterprise of gathering knowledge about the universe and organizing and condensing that knowledge into testable laws and theories". For theories and experiments to be testable, it has to be independently reproducible by peers. However, a recent study \citep{open2015estimating}  that many published studies  are not reproducible.

With the recent study highlighting a reproducibility problem of a research, previous pushes\citep{donoho2010invitation, sandve2013ten} for reproducibility in studies become more relevant than ever. Especially, computational research. Computational research involves complex computation that produces results that are important to the discipline involved. However, this complexity become a barrier for peers to validating theories and results presented, making the result looks less credible. 

These problems lead to reproducibility being hard to be done by independent peers. While science values rigorous testing and testable results, complexity in reproducing study and results hinder that. This is also one of the driving reason why Galaxy project come into development \citep{goecks2010galaxy}.  Galaxy, produce automatic metadata that record the execution of an analysis. This metadata consists of all the input files, configurations, and outputs of an analysis which are required to reproduce it. Galaxy also enables users to share the analysis with their peers that also ease the process of reproducibility in an analysis.
...
Containerization technology is something that can be used to address that problem. 
